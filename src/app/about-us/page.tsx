  ...
  return (
    <>
      <Hero
        ...
        image="https://images.unsplash.com/photo-1564121932298-c45d64b47a73?w=1920&q=80"
        imageAlt="Islamic calligraphy and community gathering"
        compact
      />
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <FadeIn>
            ...
            <ul className="mt-6 space-y-4 text-muted-foreground">
              <li className="flex items-start gap-3">
                ...
                We aim to inspire people to faith and to increase in faith
                through talks, social media, and various social activities.
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-accent" />
                We aim to educate Muslims and non-Muslims, both young and old,
                about the true Islamic teachings.
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-accent" />
                We aim to encourage the worship of Allah (Glory be to Him) and to
                serve the community.
              </li>
            </ul>
          </FadeIn>
          ...
          <FadeIn delay={0.15}>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Our vision highlights our wish for everyone among mankind to worship
              our Lord Allah alone (Glory be to Him) according to the teachings
              of His Messenger Muhammad (Peace be upon him).
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <ol className="grid gap-4 sm:grid-cols-2">
            {WHY_US.map((item, index) => (
              <FadeIn key={index} delay={index * 0.03}>
                <li className="flex gap-4 rounded-xl border border-border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
