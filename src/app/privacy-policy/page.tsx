...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Masjid Al-Athar website visitors.",
};

export default function PrivacyPolicyPage() {
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated="March 14, 2024">
      <p className="text-base leading-relaxed text-muted-foreground">
        At Masjid Al-Athar, accessible at www.masjidalathar.org, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by Masjid Al-Athar and how we
        use it.
      </p>
      <p className="text-base leading-relaxed text-muted-foreground">
        ...
        <a
          href="mailto:alatharmasjid@gmail.com"
          className="font-semibold text-primary hover:underline"
        >
          alatharmasjid@gmail.com
        </a>
        .
      </p>
      <p className="text-base leading-relaxed text-muted-foreground">
        ...
        collect on Masjid Al-Athar. This policy is not applicable to any information
      ...
      <LegalSection title="Log Files">
        <p>
          www.masjidalathar.org follows a standard procedure of using log files. These
      ...
      <LegalSection title="Cookies">
        <p>
          Like any other website, www.masjidalathar.org uses &ldquo;cookies.&rdquo;
        ...
        <p>
          Some of our advertisers on our site may use cookies and web beacons. Third-party
          ad servers or ad networks use technologies like cookies, JavaScript, or Web
          Beacons that are used in their respective advertisements and links that appear
          on our website, which are sent directly to users&apos; browsers. They
        ...
        <p>
          Note that Masjid Al-Athar has no access to or control over these cookies that
      ...
      <LegalSection title="CCPA Privacy Policy (Do Not Sell My Personal Information)">
      ...
      <LegalSection title="GDPR Privacy Policy (Data Protection Rights)">
        <p>
        ...
        <ul className="list-disc space-y-2 pl-6">
          <li>
            <strong className="text-foreground">The right to access</strong> — You have
            the right to request copies of your personal data. We may charge you a small
            fee for this service.
          </li>
          <li>
            <strong className="text-foreground">The right to rectification</strong> — You
          ...
          <li>
            <strong className="text-foreground">The right to erasure</strong> — You have
            the right to request that we erase your personal data, under certain
            conditions.
          </li>
          <li>
            <strong className="text-foreground">The right to restrict processing</strong>{" "}
            — You have the right to request that we restrict the processing of your
            personal data, under certain conditions.
          </li>
          <li>
            <strong className="text-foreground">The right to object to processing</strong>{" "}
            — You have the right to object to our processing of your personal data,
            under certain conditions.
          </li>
          <li>
            <strong className="text-foreground">The right to data portability</strong> —
      ...
      <LegalSection title="Children's Information">
        ...
        <p>
          Masjid Al-Athar does not knowingly collect any Personal Identifiable
